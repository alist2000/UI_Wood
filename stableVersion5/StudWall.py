...
from UI_Wood.stableVersion5.pointer_control import pointer_control_studWall
...
class Rectangle(QGraphicsRectItem):
    def __init__(self, x, y, rect_prop):
        ...
        self.colors = [QColor.fromRgb(152, 238, 204, 150), QColor.fromRgb(253, 231, 103, 230)]
...
class StudWallProperties(QDialog):
    ...
    def accept_control(self):
        ...
        self.accept()
        self.timer.stop()
        self.rectItem.setPen(QPen(QColor.fromRgb(152, 238, 204, 160), 2))
        self.rectItem.setBrush(QBrush(QColor.fromRgb(152, 238, 204, 150), Qt.SolidPattern))
