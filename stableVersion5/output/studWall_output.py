...
class StudWall_output:
    def __init__(self, studWalls, height, story, db):
        ...
        self.Story = story
        StoryName = story
        self.studWallProperties_everyTab = []

        self.studWallExistLine[str(StoryName)] = set()
        for StudWallItem in studWalls:
            ...
            self.studWallProperties_everyTab.append(self.studWall_dict)
