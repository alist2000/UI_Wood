...
# loadSets = {'1': {'solar': [{'type': 'Dead', 'magnitude': 0.04}, {'type': 'Live Roof', 'magnitude': 0.02}]},
#             '2': {'mechanical': [{'type': 'Dead', 'magnitude': 0.14}, {'type': 'Live Roof', 'magnitude': 0.02}]},
#             '3': {'Roof22': [{'type': 'Dead', 'magnitude': 0.04}, {'type': 'Live Roof', 'magnitude': 0.02}]}}
# print(list(loadSets.values()))
# print([list(loadSet.keys())[0] for loadSet in loadSets.values()])
