...
from WOOD_DESIGN.beamlink2new import ConvertBeamData
import sqlite3
from WOOD_DESIGN.Beamanalysisnew import BeamDesign
import pandas as pd
    ...
    def __init__(self, beam_new):
        ...
        for r in row:
            ...
            if q.beam_sec != None:
                ...
                self.query = [q.length, q.beam_sec, q.vsmax, q.mmax, q.fb_actual, q.fb_allow, q.fv_actual, q.fv_allow,
                              q.defmax, q.defl_allow, q.bending_dcr, q.shear_dcr,
